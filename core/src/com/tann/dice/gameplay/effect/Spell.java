...
public class Spell {
    ...
    public static final Spell resist3 = new Spell("Resist", "Block one damage", Main.atlas.findRegion("spell/firewave"), 3, new Eff[]{new Eff().shield(1)});

    public static final Spell resist2 = new Spell("Resist", "Block one damage", Main.atlas.findRegion("spell/healall"), 2, new Eff[]{new Eff().shield(1)});
