...
public class Spell implements Targetable{
    ...
    public static final Spell inferno = new Spell("Inferno", "2 damage to an enemy and both adjacents", Main.atlas.findRegion("spell/inferno"), 3, new Eff[]{new Eff().damage(2).enemyAndAdjacentsRanged()});
