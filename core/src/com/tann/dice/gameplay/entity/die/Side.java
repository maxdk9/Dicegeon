...
public class Side {
    ...
    public static final Side shield2 = new Side(reg, Images.get("reg/face/shield"), new Eff().shield(2).friendlySingle());

    public static final Side sword1 = new Side(reg, Images.get("reg/face/sword"), new Eff().damage(1));
    public static final Side sword2 = new Side(reg, Images.get("reg/face/sword"), new Eff().damage(2));
    public static final Side sword3 = new Side(reg, Images.get("reg/face/sword"), new Eff().damage(3));
    public static final Side sword4 = new Side(reg, Images.get("reg/face/sword"), new Eff().damage(4));
    public static final Side sword5 = new Side(reg, Images.get("reg/face/sword"), new Eff().damage(5));
    ...
    public static final Side swordShield2 = new Side(reg, Images.get("reg/face/swordShield"), new Eff().damage(2), new Eff().shield(2).self());
...
//    public static final Side arrow1 = new Side(Images.get("smol/face/arrow"), new Eff().damage(1).ranged());
    ...
    public static final Side arrow2 = new Side(reg, Images.get("reg/face/arrow"), new Eff().damage(2).ranged());
...
//    public static final Side flameWard = new Side(Images.get("flameWard"), new Eff().buff(new ReturnDamage(1, 2)).friendlySingle());
    ...
    public static final Side magic2 = new Side(reg, Images.get("reg/face/magic"), new Eff().magic(2).untargeted());

    public static final Side heal2 = new Side(reg, Images.get("reg/face/heal"), new Eff().heal(2).friendlySingle());
    public static final Side heal3 = new Side(reg, Images.get("reg/face/heal"), new Eff().heal(3).friendlySingle());
