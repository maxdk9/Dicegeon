...
//    public static final Side sword2AllSelfDamage2 = sword1AllSelfDamage1.withValue(2);
    ...
    public static final Side huge_flame1 = new Side().title("FWOOM").size(huge).image("flame").effect(new Eff().damage(1).enemyGroup());
    public static final Side huge_flame2 = huge_flame1.withValue(2);
    public static final Side huge_flame3 = huge_flame1.withValue(3);
    public static final Side huge_flame4 = huge_flame1.withValue(4);
    public static final Side huge_flame5 = huge_flame1.withValue(5);
    public static final Side huge_flame6 = huge_flame1.withValue(6);
