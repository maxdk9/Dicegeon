...
public class HeroType extends EntityType<HeroType> implements Cloneable {
    ...
    static{
        ...
        add(new HeroType().name("Rogue").hp(5).tag(fighter1)
                .sides(poison2, poison1, sword3, arrow2, vanish, nothing));
        ...
        add(new HeroType().name("Whirl").hp(7).tag(fighter1)
                .sides(whirlwind1, trident1, trident1, sword3, shieldPlusAdjacent1, nothing));
...
//                .trait(new TriggerHalfHealthEffTypeBonus(Eff.EffType.Damage, 1)));
        ...
        add(new HeroType().name("Witch").hp(6).tag(healer1)
                .sides(poison1, heal5, healBuff1, healBuff1, magic2, nothing)
