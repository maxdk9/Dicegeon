...
public class Images {
    ...
    public static final TextureRegion heart_arrow = Main.atlas.findRegion("icon/hp_arrow");
    public static final TextureRegion heart_arrow_left = Main.atlas.findRegion("icon/hp_arrow_left");
